    ...
    <section className="py-24 px-6 relative">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {/* Marketing Support */}
          <div className="bg-zinc-200/80 rounded-2xl p-6 min-h-[280px]">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 bg-gradient-to-br from-pink-300 to-purple-400 rounded-lg" />
                <div>
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <div className="flex items-center gap-2 bg-zinc-800 text-white rounded-full px-3 py-1.5">
                  <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
          ...
          {/* Web Development */}
          <div className="bg-white rounded-2xl p-6 min-h-[280px] shadow-sm">
            <h3 className="text-xl font-bold text-zinc-800 mb-2">ウェブ開発</h3>
            <p className="text-xs text-zinc-600 mb-6">
            ...
            <div className="flex gap-4">
              {/* File tree */}
              <div className="bg-zinc-100 rounded-lg p-3 text-xs space-y-1 flex-shrink-0">
              ...
              {/* Code */}
              <div className="bg-zinc-900 rounded-lg p-3 text-xs font-mono flex-1 overflow-hidden">
          ...
          {/* Accelerator */}
          <div className="bg-white rounded-2xl p-6 min-h-[280px] shadow-sm">
            <h3 className="text-xl font-bold text-zinc-800 mb-2">アクセレーター</h3>
            <p className="text-xs text-zinc-600 mb-6">
            ...
            <div className="flex items-center justify-center gap-3 mt-8">
              ...
              <div className="flex flex-col gap-2">
                <div className="w-20 h-2 bg-zinc-200 rounded-full overflow-hidden">
                  <div className="w-3/4 h-full bg-gradient-to-r from-amber-400 to-red-500 rounded-full" />
                </div>
                <div className="w-20 h-2 bg-zinc-200 rounded-full overflow-hidden">
                  <div className="w-1/2 h-full bg-gradient-to-r from-amber-400 to-red-500 rounded-full" />
                </div>
                <div className="w-20 h-2 bg-zinc-200 rounded-full overflow-hidden">
                  <div className="w-full h-full bg-gradient-to-r from-amber-400 to-red-500 rounded-full" />
                </div>
              </div>
